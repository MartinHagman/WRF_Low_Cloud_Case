...
WRF_OUTPUT_TIMES = N.array(['2018-02-18_00:00:00', '2018-02-18_06:00:00', '2018-02-18_12:00:00', '2018-02-18_18:00:00'])   #ÄNDRA DATUM
...
for AX, WRF_OUTPUT_TIME, ECMWF_TIMESTEP, SOUNDING_TIME in zip(AXS, WRF_OUTPUT_TIMES, ECMWF_TIMESTEPS, SOUNDING_TIMES):
    ...
    Filobjekt_WRF_3D_WRFOUT = N4.Dataset('/nobackup/smhid12/sm_marha/2018-02-18_00z_91_LEVELS_QC_QI_42h/run/wrfout_d01_%s' %(WRF_OUTPUT_TIME), mode='r')   #ÄNDRA SÖKVÄG TILL RÄTT WRF-KÖRNING
    ...
    QVAPOR_WRF_3D_WRFOUT = Filobjekt_WRF_3D_WRFOUT.variables['QVAPOR'][0, :, 563, 352]#[0, :, 1, 1]
...
######################################################################
    ...
    AX.plot(THETA_EC_SOD[0:VV_EC], FULL_LEVELS_EC_SOD[:VV_EC],linewidth = 1, c = 'b', label = 'IFS')
    AX.plot(THETA_WRF_3D_WRFOUT[0:VV_WRF], MASSLEVELS_WRF_3D_WRFOUT[0:VV_WRF], linewidth = 1, c = 'r', label = 'WRF')
    AX.plot(THETA_SONDERING[0:VV_SOND], HEIGHT_TER_SONDERING[0:VV_SOND], linewidth = 1, c = 'k', label = 'OBS PT')
...
fig.suptitle('Potential temperature %s' %(WRF_OUTPUT_TIME[0:10]), fontsize=20)

#fig.savefig('/home/sm_marha/FIGURES/FOKUS_17_27_FEB/18_FEB/Sounding_Intercomparison_EC_WRF_OBS')  #ÄNDRA
