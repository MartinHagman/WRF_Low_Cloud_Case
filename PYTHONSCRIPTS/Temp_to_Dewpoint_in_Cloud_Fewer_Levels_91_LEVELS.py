...
Filobjekt = N4.Dataset('/nobackup/smhid12/sm_marha/2018-02-27_00z_91_LEVELS_QC_QI_42h/run/wrfinput_d01', mode='r')
...
for place, value in enumerate(QCLOUD):
    if value > 1e-6:
        print(place, value, MASSLEVELS[place])
